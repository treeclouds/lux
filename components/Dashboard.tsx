...
export function Dashboard({ onNavigate }: DashboardProps) {
  ...
  return (
    <div className="flex-1 bg-background pb-20">
      {/* Header */}
      <div className="bg-gradient-to-r from-navy to-charcoal text-pearl px-4 pt-12 pb-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-light mb-1">{greeting}, Sarah</h1>
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="text-center">
            <div className="text-2xl font-light mb-1">847</div>
            <div className="text-xs text-pearl/70">Minutes</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-light mb-1">96%</div>
            <div className="text-xs text-pearl/70">Average</div>
          </div>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-3">
            {achievements.map((achievement, index) => {
              ...
              return (
                <Card key={index} className={`p-3 text-center ${achievement.earned ? 'bg-sage/10 border-sage/20' : 'opacity-50'}`}>
                  <Icon 
                    size={24} 
                    className={`mx-auto mb-2 ${achievement.earned ? 'text-sage' : 'text-muted-foreground'}`} 
                  />
